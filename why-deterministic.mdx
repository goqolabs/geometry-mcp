...
Ask a plain LLM what moon phase governed a date, or what was retrograde, and you get a confident guess — often different the next time you ask. GEOMETRY replaces the guess with a **lookup**: sky anchors computed offline with the standard **Swiss Ephemeris** stack<sup>†</sup>, stored once on the date spine, returned identically on every call.
