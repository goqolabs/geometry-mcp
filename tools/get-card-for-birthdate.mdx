...
geometry.app shows a **teaching excerpt** only. This page is the public docs sample builders should copy from (values from a live call; season anchors verified). Live responses can include additional nested fields and a longer `retrogrades_active` array — treat this JSON as the contract shape.
