...
Two birth dates in → both identities, connections between them, and a scored breakdown. Scoring follows cardology canon (Robert Camp connection system) — fixed weights, not tuned to fit outcomes.
