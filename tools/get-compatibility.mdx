...
**Full payload:** call this tool — the live response **is** the complete JSON (no separate `full_payload` flag). Ask your agent for the full tool result if the client truncates it.
