...
Plan limits and overage rules are shown in the Developer Portal for your subscription. During soft launch the anonymous URL may still work without a key. Once keys are required, the portal is the source of truth for quotas.
