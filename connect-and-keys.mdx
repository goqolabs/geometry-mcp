...
If you truly need the **old** key killed before the grace window (active abuse), open a **[GitHub issue](https://github.com/goqolabs/geometry-mcp/issues/new)** titled `[urgent] key revoke` and describe the situation **without** pasting the secret. This is rare; rolling + waiting covers normal cases.
