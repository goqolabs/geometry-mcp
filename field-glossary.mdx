...
description: What the numbers in the payload mean — and which ones to build on.
---
...
|---|---|---|
| `card_no` | **Tradition** | Cosmic deck position, A♦ = 1 through K♠ = 52. Stable and meaningful — the same card ordering used across cardology. |
...
| `planet_no` | **Catalog** | GEOMETRY body id. **Not** orbital order — Saturn is 8 for esoteric reasons, not because it is eighth from the Sun. Use `planet_name`. |
