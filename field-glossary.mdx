...
Payloads include numeric fields ending in `_no`. Some are traditional numbers (safe to display). Others are internal catalog ids (for support traces — not a public API contract).
