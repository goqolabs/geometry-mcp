...
<Columns cols={2}>
  <Card title="Black on light" icon="sun">
    ![Current GEOMETRY hex + 7 mark, black on light](https://raw.githubusercontent.com/goqolabs/geometry-mcp/main/logo/logo-light.svg)
  ...
  <Card title="White on dark" icon="moon">
    ![Current GEOMETRY hex + 7 mark, white on dark](https://raw.githubusercontent.com/goqolabs/geometry-mcp/main/logo/logo-dark.svg)
...
<Columns cols={2}>
  <Card title="Legacy black" icon="archive">
    ![Legacy GEOMETRY key-notch mark, black](https://raw.githubusercontent.com/goqolabs/geometry-mcp/main/logo/legacy/logo-key-light.svg)
  ...
  <Card title="Legacy white" icon="archive">
    ![Legacy GEOMETRY key-notch mark, white](https://raw.githubusercontent.com/goqolabs/geometry-mcp/main/logo/legacy/logo-key-dark.svg)
